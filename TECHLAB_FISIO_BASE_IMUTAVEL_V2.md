...
> **Identificador:** TLF-BASE-V2  
> **Versão:** 2.0  
> **Status:** IMUTÁVEL  
> **Data de congelamento:** 07 de setembro de 2026  
> **Substitui:** TLF-BASE-V1 (10 de agosto de 2026)  
...
### Histórico de versões desta base

- **TLF-BASE-V1 (10/08/2026):** Primeira versão formal congelada dos fundamentos permanentes do projeto (monorepositório com npm workspaces).
- **TLF-BASE-V2 (07/09/2026):** Substitui a TLF-BASE-V1 como base vigente, após aprovação expressa de Bruno Menezes Noronha, para registrar na Seção 9 a adoção de monorepositório com pnpm workspaces. Todos os demais fundamentos, requisitos, regras de negócio, governança e integridade clínica permanecem intactos.
...
4. Somente após aprovação explícita de Bruno Menezes Noronha poderá ser criado um novo arquivo versionado, como `TECHLAB_FISIO_BASE_IMUTAVEL_V3.md`.
...
- Monorepositório com pnpm workspaces.
...
**Fim da Base de Conhecimento Imutável — TLF-BASE-V2.**
