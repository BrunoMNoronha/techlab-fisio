...
describe("AuthModule — fronteira da F1+F2+F3 preservada", () => {
  ...
  it("as rotas expostas pela aplicação são SÓ as da F3, F6, P-2.3D-07, AUT-005, P-2.3D-10 e AUD-004", () => {
    ...
    // (`RecuperacaoSenhaModule`, `SessoesModule`, `UsuariosModule`), não no AuthModule.
