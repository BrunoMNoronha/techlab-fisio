...
describe("D-2.3D-11 — rotas da F3 presentes", () => {
  ...
  it("as rotas publicadas são EXATAMENTE as da F3, F6, P-2.3D-07, P-2.3D-08, AUT-005 e CFG-001A — nenhuma outra vazou", () => {
    ...
    // administrativa de situação de usuário. CFG-001A (`docs/14`, D-CFG-03)
    // acrescentou GET/PUT /clinica.
