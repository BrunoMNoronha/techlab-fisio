// TechLab Fisio — normalização dos erros das rotas `/profissionais` (PRO-001, PRO-004, PRO-005).
//
...
// tudo o que ocorre a partir das guards e dos handlers de `/profissionais`:
//
...
@Catch()
export class FiltroErroProfissionais implements ExceptionFilter {
  readonly #logger = new Logger("Profissionais");
    ...
    this.#logger.error(
      `Falha inesperada no cadastro de profissionais. classe=${
