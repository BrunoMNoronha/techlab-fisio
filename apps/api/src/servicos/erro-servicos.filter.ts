// TechLab Fisio — normalização dos erros das rotas `/servicos` (CFG-003).
//
...
// tudo o que ocorre a partir das guards e dos handlers de `/servicos`:
//
...
@Catch()
export class FiltroErroServicos implements ExceptionFilter {
  readonly #logger = new Logger("CatalogoServicos");
    ...
    this.#logger.error(
      `Falha inesperada no catálogo de serviços. classe=${
