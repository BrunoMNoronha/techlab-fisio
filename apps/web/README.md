...
A base formal vigente é a [`TECHLAB_FISIO_BASE_IMUTAVEL_V1.md`](../../TECHLAB_FISIO_BASE_IMUTAVEL_V1.md); a [`TECHLAB_FISIO_BASE_IMUTAVEL_V2.md`](../../TECHLAB_FISIO_BASE_IMUTAVEL_V2.md) é a sucessora candidata criada para registrar pnpm workspaces, pronta para substituir a V1 após publicação autorizada (§2 idioma/mobile first, §9 arquitetura de referência, §11 requisitos não funcionais). A baseline de versões é [`docs/08`](../../docs/08-baseline-tecnica-plano-implementacao.md) §6; a execução de `V-06.c` (teto do TypeScript 6.0 × Next.js 16) está registrada em `docs/08` §12.1/§12.2.
