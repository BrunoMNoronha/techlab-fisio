...
| REV. | Data | Descrição |
| --- | --- | --- |
| **11** | 17/09/2026 | Reconciliação factual pós-integração de §5: `P-CFG-03` / `CFG-002` integrada pela PR #76 (merge `ad2bcf8`). O registro da REV. 10 permanece como histórico. Nenhuma decisão normativa criada, alterada ou reaberta. |
