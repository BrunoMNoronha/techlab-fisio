...
| Item | Estado |
| --- | --- |
| Implementação de PRO-003 (rotas, regra de versões, migration de `D-PRO3-06`) | **IMPLEMENTADA E MEDIDA** em branch local `agent/pro-003-disponibilidade-profissional`, a partir de `origin/main` = `92bcf6e` — **NÃO PUBLICADA** (§5.3; `docs/10` §6-AG) |
