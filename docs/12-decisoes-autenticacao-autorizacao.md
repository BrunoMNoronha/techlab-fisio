...
> **Data:** 27 de agosto de 2026 (REV. 3 a REV. 5 em 28/08/2026; REV. 6 em 31/08/2026; REV. 7 em 02/09/2026; REV. 8 e REV. 9 em 05/09/2026; REV. 10 e REV. 11 em 06/09/2026; REV. 12 em 14/09/2026; REV. 13 e REV. 14 em 15/09/2026; REV. 15 em 16/09/2026; REV. 16 a REV. 18 em 17/09/2026)
...
- **Método seguro:** **sem** `ProtecaoCsrfGuard` e sem `X-TLF-Requisicao`, pelo mesmo racional de `D-2.3D-20`. A consulta **não escreve nada** — nem a detecção persistente de expiração que `validar` executa.
...
- **Erros:** `400 REQUISICAO_INVALIDA` para `usuarioId` estruturalmente inválido; `401`, `403` e `500` pelos contratos gerais vigentes (`D-2.3D-07`, `D-2.3D-09`, `D-2.3D-11`).
...
| `P-2.3D-10` | **Implementação da listagem administrativa das sessões ativas de um usuário (AUT-002 / `sessoes.revogar_terceiro`), conforme `D-2.3D-22`** | **IMPLEMENTADA EM BRANCH PRÓPRIA (`agent/sessoes-admin-next`) — NÃO INTEGRADA NA `main`.** Rota `GET /auth/usuarios/:usuarioId/sessoes`; critérios `L-01`..`L-14` (§10.7) e mutation challenges M1..M4 provados; zero drift |
