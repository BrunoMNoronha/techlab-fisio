...
| `P-2.3D-07` | **Implementação da revogação administrativa de sessão de terceiro (AUT-002 / `sessoes.revogar_terceiro`), conforme `D-2.3D-19`** | **IMPLEMENTADA EM BRANCH PRÓPRIA em 14/09/2026 (`agent/p-2.3d-07-revogacao-sessao-terceiro`)** — Critérios de aceite `A-01`..`A-22` plenamente atendidos e provados por testes unitários e de integração contra PostgreSQL real. Quatro mutation challenges mandatórios executados e revertidos. Rota `DELETE /auth/sessoes/:sessaoId` entregue com RBAC, envelope uniforme 204, atomicidade da auditoria e zero drift. Aguarda homologação e rito de integração na `main` por Bruno Menezes Noronha |
...
| **AUT-002** — Encerrar, expirar e revogar sessões | `D-2.3D-01` (janela física), `D-2.3D-04` (expiração absoluta e ociosa), `D-2.3D-05` (estados terminais), `D-2.3D-18` (autoria da revogação em massa da T-07), **`D-2.3D-19` (revogação administrativa de terceiro — MATERIALIZADA em 14/09/2026)** | **PARCIAL.** Estados e transições preservados **sem alteração**: `ATIVA -> EXPIRADA`, `ATIVA -> REVOGADA`. **Implementados:** logout, expiração, revogação em massa da T-07 e revogação administrativa de terceiro (`D-2.3D-19` / `P-2.3D-07`). **NÃO implementada e sem decisão nesta revisão:** inativação de usuário (AUT-005) |
...
**Fim — `docs/12-decisoes-autenticacao-autorizacao.md` — `D-2.3D-01`..`D-2.3D-19` registradas; F0 da Etapa 2.3D-B executada em 27/08/2026; `D-2.3D-13` homologada em 28/08/2026; `D-2.3D-14` e `D-2.3D-15` homologadas em 31/08/2026; `D-2.3D-16`, `D-2.3D-17` e `D-2.3D-18` homologadas em 05/09/2026; F0..F7 CONCLUÍDAS e Etapa 2.3D ENCERRADA em 05/09/2026; `D-2.3D-19` homologada em 06/09/2026 — decisão normativa da revogação administrativa de sessão de terceiro; REV. 12 (14/09/2026) registra a conclusão técnica de `P-2.3D-07` / `AUT-002` (`sessoes.revogar_terceiro`) em branch própria com critérios `A-01`..`A-22` CONCLUÍDOS, quatro mutation challenges validados e zero drift, aguardando homologação e rito de integração na `main`.**
